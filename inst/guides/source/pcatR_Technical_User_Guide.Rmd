...
Temporary paths keep documentation examples out of the current working
directory. For operational use, select an explicit, approved project path.
...
When the barrier or facilitator share is unavailable, including after small-cell suppression, `polarized` is missing rather than `FALSE`. Suppressed rows retain `consensus_label = "insufficient_data"`; unavailable data are not interpreted as evidence that a cell is nonpolarized.
