...
The same downloaded bytes passed exact-archive checks with full PDF
manuals under current R-release and R-devel in run `30181084279`; their
log artifacts are `8625631346` and `8625630473`. Coverage run
`30181084286` and pkgdown run `30181084290` also passed. The exact
retained archive was submitted to Win-builder R-release and R-devel on
July 25, 2026. Both results were reviewed, and the archive has not been
submitted to CRAN.
