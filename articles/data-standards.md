...
percentages use `n_complete_class`. These denominators may differ when
an effect response is missing. Report both rather than silently treating
missing effect responses as weak effects.
