...
[![License:
MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://jaemanp.github.io/pcatR/LICENSE)

`pcatR` is an independent R package for reproducible analysis of the
14-item **Pragmatic Context Assessment Tool (pCAT)**. It imports and
validates response data, classifies barriers and facilitators,
summarizes item-level patterns, describes team agreement and
disagreement, compares repeated assessments, creates implementation
action-planning tables, and produces publication-ready figures.
...
- uses the `-2` to `+2` display code only for plotting and within-item
  transition descriptions;
- treats implementation-strategy links as prompts for local
  deliberation, not automated prescriptions; and
...
`pcatR` is a pure-R package. Its required plotting dependency,
`ggplot2`, is installed automatically by standard package installers.
The optional Shiny interface requires `shiny`.
...
Leave `effect` blank when `direction = 2` (neutral). A neutral response
paired with any effect value is flagged by default.
...
The display code must not be summed across items or treated as an
interval-scale outcome.

## Standard long-format data

Required columns are `respondent_id`, `item_id`, `direction`, and
`effect`. Recommended metadata columns include `project_id`, `site_id`,
`team_id`, `role`, `timepoint`, `assessment_date`, and `comment`.
...
|----|----|
| Instrument and mappings | [`pcat_items()`](https://jaemanp.github.io/pcatR/reference/pcat_items.md), [`pcat_construct_map()`](https://jaemanp.github.io/pcatR/reference/pcat_items.md), [`pcat_response_options()`](https://jaemanp.github.io/pcatR/reference/pcat_items.md) |
| Templates and import | [`pcat_template()`](https://jaemanp.github.io/pcatR/reference/pcat_standardize.md), [`pcat_write_template()`](https://jaemanp.github.io/pcatR/reference/pcat_standardize.md), [`pcat_read_csv()`](https://jaemanp.github.io/pcatR/reference/pcat_standardize.md), [`pcat_standardize()`](https://jaemanp.github.io/pcatR/reference/pcat_standardize.md) |
| Validation | [`pcat_validate()`](https://jaemanp.github.io/pcatR/reference/pcat_validate.md), [`pcat_validation_issues()`](https://jaemanp.github.io/pcatR/reference/pcat_validate.md) |
| Classification | [`pcat_classify()`](https://jaemanp.github.io/pcatR/reference/pcat_classify.md) |
| End-to-end analysis | [`pcat_analyse()`](https://jaemanp.github.io/pcatR/reference/pcat_analyse.md) |
| Item summaries | [`pcat_summarise()`](https://jaemanp.github.io/pcatR/reference/pcat_summarise.md) |
| Agreement/disagreement | [`pcat_consensus()`](https://jaemanp.github.io/pcatR/reference/pcat_summarise.md) |
| Repeated assessment | [`pcat_change()`](https://jaemanp.github.io/pcatR/reference/pcat_summarise.md) |
| Action planning | [`pcat_action_plan()`](https://jaemanp.github.io/pcatR/reference/pcat_summarise.md), [`pcat_strategy_candidates()`](https://jaemanp.github.io/pcatR/reference/pcat_items.md) |
| Figures | [`plot_pcat_profile()`](https://jaemanp.github.io/pcatR/reference/plot_pcat_profile.md), [`plot_pcat_heatmap()`](https://jaemanp.github.io/pcatR/reference/plot_pcat_profile.md), [`plot_pcat_change()`](https://jaemanp.github.io/pcatR/reference/plot_pcat_profile.md) |
| Export | [`pcat_write_analysis()`](https://jaemanp.github.io/pcatR/reference/pcat_write_analysis.md), [`pcat_save_profile_pdf()`](https://jaemanp.github.io/pcatR/reference/pcat_write_analysis.md) |
| Technical guide | [`pcat_user_guide()`](https://jaemanp.github.io/pcatR/reference/pcat_user_guide.md) |
...
Supplementary Table S3: `Available Resources: Materials & Equipment`
(primary in the package dictionary) and `Available Resources: Funding`
...
Use coded respondent identifiers. Do not place names, medical-record
...
Analyses should cite the software, the original pCAT development
article, and, when updated CFIR mappings are used, the 2026 mapping
...
Veterans Affairs, the CFIR Leadership Team, or the instrument
repository.
...
See
[CONTRIBUTING.md](https://github.com/JaeManP/pcatR/blob/main/CONTRIBUTING.md),
[GOVERNANCE.md](https://github.com/JaeManP/pcatR/blob/main/GOVERNANCE.md),
and
[SECURITY.md](https://github.com/JaeManP/pcatR/blob/main/SECURITY.md)
before contributing.
